...
if __name__ == "__main__":
    ...
    percent = Button(gui, text='%', fg='white', bg='black',
                     command=PERCENTEQUAL, height=1, width=7)
    percent.grid(row=2, column=0)
    exponent = Button(gui, text='^', fg='white', bg='black',
                    command=lambda: press("**"), height=1, width=7)
    exponent.grid(row=2, column=2)
    pi = Button(gui,text='π', fg='white', bg='black',
                     command=math.pi, height=1, width=7)
